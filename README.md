...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https%3A%2F%2Fgithub.com%2FHardbroke%2FAIheroku)
...
`UUID` 默认为 `3736c16c-e67d-4645-9a0b-229b16bc5aba` 可自行设置。
